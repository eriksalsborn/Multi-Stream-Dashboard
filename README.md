...
```
cd existing_repo
git remote add origin https://gitlab.liu.se/andlu554/multistream.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.liu.se/andlu554/multistream/-/settings/integrations)
